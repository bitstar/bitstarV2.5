...
BOOST_AUTO_TEST_CASE(test_addresses)
{
    ...
    std::vector<std::string> pubkey = {"bitstar:qpm2qsznhks23z7629mms6s4cwef74vcwvy22gdx6a",
        "bitstar:qr95sy3j9xwd2ap32xkykttr4cvcu7as4y0qverfuy",
        "bitstar:qqq3728yw0y47sqn6l2na30mcw6zm78dzqre909m2r"};
    std::vector<std::string> script = {"bitstar:ppm2qsznhks23z7629mms6s4cwef74vcwvn0h829pq",
        "bitstar:pr95sy3j9xwd2ap32xkykttr4cvcu7as4yc93ky28e",
        "bitstar:pqq3728yw0y47sqn6l2na30mcw6zm78dzq5ucqzc37"};
